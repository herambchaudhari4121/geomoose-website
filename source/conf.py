# -*- coding: utf-8 -*-
#
# GeoMOOSE documentation build configuration file, created by
# sphinx-quickstart on Mon Aug 19 11:13:39 2013.
#
...
html_sidebars = {
	'**': ['searchbox.html', 'logos.html', 'localtoc.html', 'relations.html', 'sourcelink.html']
}
...
texinfo_documents = [
  ('index', 'GeoMOOSE', u'GeoMOOSE Documentation',
   u'GeoMOOSE', 'GeoMOOSE', 'One line description of project.',
   'Miscellaneous'),
]
